...
namespace ProyectoGraficacion
{
    class Program
    {
        ...
        static void dibujarTocho()
        {
            ...
            dibujarLlantas();
            dibujarConexcionLLantasDelanteras();
            Gl.glPopMatrix();
        ...
        static void dibujarLlanta(){
            ...
            Gl.glPushMatrix();
            Gl.glScaled(1, 1,1f);
            Glut.glutSolidTorus(.1f,1f, 100, 100);
            Gl.glPopMatrix();

            //DibujarAroRin
            Gl.glMaterialfv(Gl.GL_FRONT, Gl.GL_AMBIENT, mat_ambient_plateado);
            Gl.glPushMatrix();
            Glut.glutSolidTorus(.1f, .9f, 100, 100);
            Gl.glPopMatrix();
           ...
           Gl.glTranslated(0, 0, -.1f);
            Glut.glutSolidCylinder(.15f, .2, 100, 100);
            Gl.glPopMatrix();

            //Dibujar adorno del rin
            Gl.glMaterialfv(Gl.GL_FRONT, Gl.GL_AMBIENT, mat_ambient_negro);
            Gl.glPushMatrix();
            Gl.glTranslated(0, 0, -.15f);
            Glut.glutSolidCylinder(.08f, .3f, 100, 100);
            Gl.glPopMatrix();
        ...
        static void dibujarConexcionLLantasDelanteras() {
            Gl.glMaterialfv(Gl.GL_FRONT, Gl.GL_AMBIENT, mat_ambient_gris);

          //  //Maniubro
            Gl.glPushMatrix();
              Gl.glTranslated(-1.5f, 2, 0);
              Gl.glRotatef(giroLLantasDelanteras, 0, 1, 0);
            Gl.glTranslated(0, 0, -1);
            Glut.glutSolidCylinder(.08f, 2f, 100, 100);
            Gl.glPopMatrix();
            ...
            Glut.glutSolidCylinder(.09f, .3f, 100, 100);
            Gl.glPopMatrix();
            ...
            Gl.glPushMatrix();
            Gl.glTranslated(-2, 0, .19f);
            Gl.glRotatef(giroLLantasDelanteras, 0, 1, 0);
            Gl.glRotated(-15, 0, 0, 1);
            Gl.glRotated(270, 1, 0, 0);
            Glut.glutSolidCylinder(.05f, 2f, 100, 100);
            Gl.glPopMatrix();
            ...
            Gl.glRotated(270, 1, 0, 0);
            Glut.glutSolidCylinder(.05f, 2.3f, 100, 100);
            Gl.glPopMatrix();
            ...
            Gl.glRotated(270, 1, 0, 0);
            Glut.glutSolidCylinder(.05f, 2.2f, 100, 100);
